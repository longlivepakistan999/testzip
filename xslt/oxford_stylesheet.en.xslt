...
<xsl:variable name="invalid_embedded_mode_request" ></xsl:variable>
...
<xsl:variable name="logo_url"><xsl:value-of
    select="$gsa_resource_root_path_prefix" />http://www.emory.edu/_images/logo_emory_shield.gif</xsl:variable>
<xsl:variable name="logo_width">183</xsl:variable>
<xsl:variable name="logo_height">48</xsl:variable>
...
<xsl:variable name="analytics_account">UA-1875823-7</xsl:variable>
...
&lt;head&gt;
	&lt;!--## Meta tags --&gt;
	&lt;!-- tags that need to be at the top --&gt;
	&lt;meta charset="utf-8"&gt;
	&lt;meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"&gt;
	&lt;!-- title --&gt;
	&lt;title&gt;Home - Oxford College&lt;/title&gt;
	&lt;!-- describing tags --&gt;
	...
	&lt;meta name="viewport" content="width=device-width, initial-scale=1.0"&gt;
		...
		&lt;meta name="google-site-verification" content="T8sBSaAdcyBLR_y_c2-rtcpm0_dbfIZVRWbFFkNl7Gs" /&gt;
		&lt;!-- Google Analytics verification code --&gt;
		&lt;meta name="verify-v1" content="tnA6au+oH/oo28pFqe7XJWl63nIyik8F7vRTnml5kvI=" /&gt;
	

	&lt;!--## Favicons --&gt;
	&lt;!-- favicons --&gt;
	&lt;link rel="icon" href="http://oxford.emory.edu/favicon.ico" type="image/x-icon" /&gt;
	&lt;link rel="shortcut icon" href="http://oxford.emory.edu/favicon.ico" type="image/x-icon" /&gt;
	&lt;!-- ie favicons --&gt;
	...
	&lt;!--## CSS --&gt;
	&lt;!-- Bootstrap --&gt;
	&lt;link rel="stylesheet" href="http://oxford.emory.edu/oxford/jquery/bootstrap-3.1.1-custom/css/bootstrap.min.css"&gt;
	&lt;!-- Font Awesome --&gt;
	...
	&lt;![endif]--&gt;
		...
		&lt;link rel="stylesheet" href="http://oxford.emory.edu/oxford/includes/themes/oxford/assets/static/mura.root.2014-03-05.min.css"&gt;
		&lt;!-- Shell, grid, and home page styles --&gt;
		&lt;link rel="stylesheet" href="http://oxford.emory.edu/oxford/includes/themes/oxford/assets/static/oxford.home.2014-11-04.min.css"&gt;
	...
	&lt;!--## Javascript --&gt;
	&lt;!-- Modernizr --&gt;
	&lt;script src="http://oxford.emory.edu/oxford/js/modernizr-2.6.2.min.js"&gt;&lt;/script&gt;
	&lt;!-- jQuery --&gt;
	&lt;!--[if lt IE 9]&gt;
	...
	&lt;script src="http://oxford.emory.edu/oxford/jquery/plugins/jquery.placehold/jquery.placehold.min.js"&gt;&lt;/script&gt;
	&lt;!-- local scripts --&gt;
	
		&lt;script src="http://oxford.emory.edu/oxford/includes/themes/oxford/assets/static/oxford.root.2014-11-04.min.js"&gt;&lt;/script&gt;
	

	
 &lt;script type="text/javascript"&gt; 
&lt;!--
!window.jQuery &amp;&amp; document.write(unescape('%3Cscript type="text/javascript" src="http://oxford.emory.edu/oxford/jquery/jquery.js"%3E%3C/script%3E'))
//--&gt;
...
&lt;script type="text/javascript" src="http://oxford.emory.edu/oxford/js/global.min.js"&gt;&lt;/script&gt;
&lt;script type="text/javascript"&gt;
...
var context=""; 
var jslib="jquery";
var assetpath="http://oxford.emory.edu/oxford";
var themepath="http://oxford.emory.edu/oxford/includes/themes/oxford";
var htmlEditorType="";
var rb="en";
&lt;/script&gt;
			&lt;script src="http://oxford.emory.edu/oxford/jquery/plugins/jquery.rotator/jquery.rotator.js"&gt;&lt;/script&gt;
			&lt;script&gt;
			...
			&lt;/script&gt;
		&lt;/head&gt;
&lt;body id="homepage" class="sysHome home"&gt;
	&lt;!-- Container --&gt;
	&lt;div class="container"&gt;
		&lt;!-- Blue Header --&gt;
		&lt;header id="header" class="row"&gt;
			...
			&lt;div class="col-sm-12"&gt;
				&lt;div id="logo"&gt;
					&lt;a href="http://oxford.emory.edu"&gt;&lt;img src="http://oxford.emory.edu/oxford/includes/themes/oxford/assets/images/oxford-logo.gif" class="img-responsive" alt="Oxford College of Emory University Logo" /&gt;&lt;/a&gt;
				&lt;/div&gt;
			&lt;/div&gt; &lt;!-- /Logo --&gt;
			&lt;!-- Search --&gt;
			&lt;div class="col-sm-12"&gt;
				&lt;div id="search" class="iconMenu"&gt;
					&lt;ul&gt;
						&lt;li&gt;&lt;input type="radio" id="oxdir" name="searchtype" value="oxdir" /&gt;&lt;label for="oxdir"&gt;Oxford Directory&lt;/label&gt;&lt;/li&gt;
						&lt;li&gt;&lt;input type="radio" id="emsites" name="searchtype" value="emsites" /&gt;&lt;label for="emsites"&gt;Emory Sites&lt;/label&gt;&lt;/li&gt;
					&lt;/ul&gt;
					&lt;form name="searchform" id="searchform" action="http://search.emory.edu/search" method="get"&gt;
						&lt;input type="hidden" name="site" id="site" value="oxford" /&gt;
						&lt;input type="hidden" name="proxystylesheet" id="proxystylesheet" value="oxford" /&gt;
						&lt;input type="hidden" name="output" id="output" value="xml_no_dtd" /&gt;
						&lt;input type="hidden" name="client" id="client" value="oxford" /&gt;
						&lt;input type="hidden" name="filter" id="filter" value="0" /&gt;
						&lt;input type="hidden" name="fuseaction" id="fuseaction" value="v.searchresults" /&gt;
						&lt;input type="text" class="searchInput" name="q" id="q" placeholder="Oxford College" /&gt;
						&lt;input type="image" class="searchBtn" src="http://oxford.emory.edu/oxford/includes/themes/oxford/assets/images/search-btn.gif" alt="Search" /&gt;
					&lt;/form&gt;
				&lt;/div&gt;
			&lt;/div&gt; &lt;!-- /Search --&gt;
		&lt;/header&gt; &lt;!-- /Blue Header --&gt;
		&lt;!-- Icon bar on narrow screens --&gt;
		&lt;div id="goldIconBar" class="row"&gt;
			&lt;div class="col-xs-5"&gt;&lt;a id="navMenu" class="expandMenu" data-expand="goldNav" href="#"&gt;&lt;i class="fa fa-bars fa-2x"&gt;&lt;/i&gt;&lt;/a&gt;&lt;/div&gt;
			&lt;div class="col-xs-5"&gt;&lt;a id="linksMenu" class="expandMenu" data-expand="favNav" href="#"&gt;&lt;i class="fa fa-ellipsis-v fa-2x"&gt;&lt;/i&gt;&lt;/a&gt;&lt;/div&gt;
			&lt;div class="col-xs-4"&gt;&lt;a id="socialMenu" class="expandMenu" data-expand="mediaHeader" href="#"&gt;&lt;i class="fa fa-share-alt fa-2x"&gt;&lt;/i&gt;&lt;/a&gt;&lt;/div&gt;
			&lt;div class="col-xs-5"&gt;&lt;a id="calMenu" class="expandMenu" data-expand="eventsNav" href="#"&gt;&lt;i class="fa fa-calendar fa-2x"&gt;&lt;/i&gt;&lt;/a&gt;&lt;/div&gt;
			&lt;div class="col-xs-5"&gt;&lt;a id="searchMenu" class="expandMenu" data-expand="search" href="#"&gt;&lt;i class="fa fa-search fa-2x"&gt;&lt;/i&gt;&lt;/a&gt;&lt;/div&gt;
		&lt;/div&gt;
		&lt;!-- Events Nav Bar (narrow screens only) --&gt;
		&lt;nav id="eventsNav" class="clearfix iconMenu"&gt;
			&lt;div class="goldMenu"&gt;
				&lt;ul&gt;
					&lt;li&gt;&lt;a href="http://oxford.emory.edu/events-calendar/"&gt;Events Calendar&lt;/a&gt;&lt;/li&gt;
					&lt;li&gt;&lt;a href="http://oxford.emory.edu/operations/events-conferences/artisticlyceum-events/"&gt;Arts/Lyceum Events&lt;/a&gt;&lt;/li&gt;
					&lt;li&gt;&lt;a href="http://oxford.emory.edu/academics/academic-calendar/"&gt;Academic Calendar&lt;/a&gt;&lt;/li&gt;
					&lt;li&gt;&lt;a href="http://transportation.emory.edu/shuttles/Oxford.html" target="_blank"&gt;Shuttle Schedule&lt;/a&gt;&lt;/li&gt;
				&lt;/ul&gt;
			&lt;/div&gt;
		&lt;/nav&gt;
		&lt;nav id="favNav" class="clearfix iconMenu"&gt;
			&lt;div class="goldMenu"&gt;
				&lt;ul&gt;
					&lt;li&gt;&lt;a href="https://app.oxford.emory.edu/WebApps/Directories/index.cfm" title="Directory"&gt;Directory&lt;/a&gt;&lt;/li&gt;
					&lt;li&gt;&lt;a href="http://oxford.emory.edu/visit-oxford/maps-and-directions/" title="Maps and Directions"&gt;Maps and Directions&lt;/a&gt;&lt;/li&gt;
					&lt;li&gt;&lt;a href="http://oxford.library.emory.edu/" target="_blank" title="Library"&gt;Library&lt;/a&gt;&lt;/li&gt;
					&lt;li&gt;&lt;a href="http://transportation.emory.edu/shuttles/Oxford.html" target="_blank" title="Shuttle Schedule"&gt;Shuttle Schedule&lt;/a&gt;&lt;/li&gt;
					&lt;li&gt;&lt;a href="http://oxford.emory.edu/events-calendar/" title="Events Calendar"&gt;Events Calendar&lt;/a&gt;&lt;/li&gt;
					&lt;li&gt;&lt;a href="http://email.emory.edu" target="_blank" title="Office 365/Email"&gt;Office 365/Email&lt;/a&gt;&lt;/li&gt;
					&lt;li&gt;&lt;a href="http://oxford.emory.edu/academics/academic-calendar/" title="Academic Calendar"&gt;Academic Calendar&lt;/a&gt;&lt;/li&gt;
					&lt;li&gt;&lt;a href="https://opus.emory.edu" target="_blank" title="OPUS"&gt;OPUS&lt;/a&gt;&lt;/li&gt;
					&lt;li&gt;&lt;a href="http://oxford.emory.edu/operations/information-technology/" title="Computing"&gt;Computing&lt;/a&gt;&lt;/li&gt;
					&lt;li&gt;&lt;a href="https://classes.emory.edu/webapps/portal/frameset.jsp" target="_blank" title="Blackboard"&gt;Blackboard&lt;/a&gt;&lt;/li&gt;
					&lt;li&gt;&lt;a href="http://oxford.emory.edu/operations/human-resources/" title="Human Resources"&gt;Human Resources&lt;/a&gt;&lt;/li&gt;
					&lt;li&gt;&lt;a href="http://emory.bncollege.com/webapp/wcs/stores/servlet/BNCBHomePage?storeId=65062&amp;catalogId=10001&amp;langId=-1" target="_blank" title="Bookstore"&gt;Bookstore&lt;/a&gt;&lt;/li&gt;
					&lt;li&gt;&lt;a href="http://oxford.emory.edu/life-at-oxford/campus-police/emergency-contacts/" title="Emergency Contacts"&gt;Emergency Contacts&lt;/a&gt;&lt;/li&gt;
					&lt;li&gt;&lt;a href="http://oxford.emory.edu/operations/events-conferences/artisticlyceum-events/" title="Arts"&gt;Arts&lt;/a&gt;&lt;/li&gt;
					&lt;li&gt;&lt;a href="https://25live.collegenet.com/emory/" target="_blank" title="Room Reservations (25Live)"&gt;25Live&lt;/a&gt;&lt;/li&gt;
					&lt;li&gt;&lt;a href="http://oxford.emory.edu/life-at-oxford/campus-police/" title="Campus Police"&gt;Campus Police&lt;/a&gt;&lt;/li&gt;
				&lt;/ul&gt;
			&lt;/div&gt;
		&lt;/nav&gt;
		&lt;div id="mediaHeader" class="mediabtnsNav iconMenu"&gt;
			&lt;div class="row SMmenu"&gt;
				&lt;div class="col-xs-3 FacebookNav"&gt;&lt;a href="http://www.facebook.com/pages/Oxford-GA/Oxford-College-of-Emory-University/81895437026" target="_blank" title="Facebook"&gt;&lt;span&gt;Facebook&lt;/span&gt;&lt;/a&gt;&lt;/div&gt;
				&lt;div class="col-xs-3 TwitterNav"&gt;&lt;a href="http://twitter.com/OxfordCollege" target="_blank" title="Twitter"&gt;&lt;span&gt;Twitter&lt;/span&gt;&lt;/a&gt;&lt;/div&gt;
				&lt;div class="col-xs-3 YoutubeNav"&gt;&lt;a href="http://www.youtube.com/EmoryUniversity" target="_blank" title="Youtube"&gt;&lt;span&gt;Youtube&lt;/span&gt;&lt;/a&gt;&lt;/div&gt;
				&lt;div class="col-xs-3 InstagramNav"&gt;&lt;a href="http://instagram.com/oxfordcollege" target="_blank" title="Instagram"&gt;&lt;span&gt;Instagram&lt;/span&gt;&lt;/a&gt;&lt;/div&gt;
				&lt;div class="col-xs-3 FlickrNav"&gt;&lt;a href="http://www.flickr.com/photos/oxfordcollege/show/" target="_blank" title="Flickr"&gt;&lt;span&gt;Flickr&lt;/span&gt;&lt;/a&gt;&lt;/div&gt;
				&lt;div class="col-xs-3 BlogNav"&gt;&lt;a href="https://blogs.emory.edu/admissionblog/" target="_blank" title="Oxford Blog"&gt;&lt;span&gt;Oxford Blog&lt;/span&gt;&lt;/a&gt;&lt;/div&gt;
				&lt;div class="col-xs-3 iTunesNav"&gt;&lt;a href="http://www.itunes.emory.edu/" target="_blank" title="iTunes"&gt;&lt;span&gt;iTunes&lt;/span&gt;&lt;/a&gt;&lt;/div&gt;
				&lt;div class="col-xs-3 MobileNav"&gt;&lt;a href="http://www.emory.edu/mobile/" target="_blank" title="Mobile"&gt;&lt;span&gt;Mobile&lt;/span&gt;&lt;/a&gt;&lt;/div&gt;
			&lt;/div&gt;
		&lt;/div&gt; &lt;!-- /mediabtnsNav --&gt;
		&lt;!-- Gold Nav Bar --&gt;
		&lt;nav id="goldNav" class="clearfix iconMenu"&gt;
			&lt;div id="goldNavContainer" class="goldMenu"&gt;
				
					
						&lt;ul id="navPrimary"&gt;
							&lt;li class="first" id="navADistinctivePlace"&gt;&lt;a href="http://oxford.emory.edu/a-distinctive-place/"&gt;A Distinctive Place&lt;/a&gt;&lt;/li&gt;
							&lt;li id="navAdmission"&gt;&lt;a href="http://oxford.emory.edu/admission/" target="_blank"&gt;Admission&lt;/a&gt;&lt;/li&gt;
							&lt;li id="navAcademics"&gt;&lt;a href="http://oxford.emory.edu/academics/"&gt;Academics&lt;/a&gt;&lt;/li&gt;
							&lt;li id="navFinancialAid"&gt;&lt;a href="http://oxford.emory.edu/financial-aid/"&gt;Financial Aid&lt;/a&gt;&lt;/li&gt;
							&lt;li id="navLifeAtOxford"&gt;&lt;a href="http://oxford.emory.edu/life-at-oxford/"&gt;Life at Oxford&lt;/a&gt;&lt;/li&gt;
							&lt;li id="navAthletics"&gt;&lt;a href="http://oxford.emory.edu/athletics/"&gt;Athletics&lt;/a&gt;&lt;/li&gt;
							&lt;li id="navGiveToOxford"&gt;&lt;a href="http://oxford.emory.edu/give-to-oxford/" target="_blank"&gt;Give to Oxford&lt;/a&gt;&lt;/li&gt;
							&lt;li id="navProspectiveStudents"&gt;&lt;a href="http://oxford.emory.edu/prospective-students/"&gt;Prospective Students&lt;/a&gt;&lt;/li&gt;
							&lt;li id="navAlumniAndFriends"&gt;&lt;a href="http://oxford.emory.edu/alumni-and-friends/"&gt;Alumni and Friends&lt;/a&gt;&lt;/li&gt;
							&lt;li id="navCurrentStudents"&gt;&lt;a href="http://oxford.emory.edu/current-students/"&gt;Current Students&lt;/a&gt;&lt;/li&gt;
							&lt;li id="navFacultyAndStaff"&gt;&lt;a href="http://oxford.emory.edu/faculty-and-staff/"&gt;Faculty and Staff&lt;/a&gt;&lt;/li&gt;
							&lt;li class="last" id="navVisitorsAndParents"&gt;&lt;a href="/visitors-and-parents/"&gt;Visitors and Parents&lt;/a&gt;&lt;/li&gt;
						&lt;/ul&gt;
		...
		&lt;!-- /Emergency Banner --&gt;
		&lt;!-- Body --&gt;
		&lt;div id="bodyContent" style="background-color:#fff; padding:20px;"&gt;
    				


	&lt;div class="pure-g-r" style="padding:15px;"&gt;</xsl:text>
</xsl:template>
...
&lt;/div&gt;
			...
			&lt;div id="divAcrossBottom" class="clearfix"&gt;
		...
		&lt;div id="utilityNav"&gt;
			&lt;ul&gt;
				&lt;li class="topLevel"&gt;
					&lt;a class="utilLink" title="Resources"&gt;&lt;span&gt;Resources&lt;/span&gt;&lt;/a&gt;
					&lt;div class="flyOut"&gt;
						&lt;div class="col col1"&gt;
							&lt;h4&gt;Resources&lt;/h4&gt;
							&lt;ul&gt;
								&lt;li&gt;&lt;a href="http://www.emory.edu/home/about/administration/" title="Administrative Offices"&gt;Administrative Offices&lt;/a&gt;&lt;/li&gt;
								...
								&lt;li&gt;&lt;a href="http://www.carlos.emory.edu/" target="_blank" title="Michael C. Carlos Museum"&gt;Michael C. Carlos Museum&lt;/a&gt;&lt;/li&gt;
						...
						&lt;div class="col col2"&gt;
							&lt;h4&gt;Resources&lt;/h4&gt;
							&lt;ul&gt;
								&lt;li&gt;&lt;a href="http://www.emory.edu/home/emergency/index.html" title="Emergency Contacts"&gt;Emergency Contacts&lt;/a&gt;&lt;/li&gt;
								...
								&lt;li&gt;&lt;a href="http://www.hr.emory.edu/careers/" target="_blank" title="Careers"&gt;Careers&lt;/a&gt;&lt;/li&gt;
								&lt;li&gt;&lt;a href="http://www.hr.emory.edu/eu/" target="_blank" title="Human Resources"&gt;Human Resources&lt;/a&gt;&lt;/li&gt;
								&lt;li&gt;&lt;a href="http://www.alumni.emory.edu/" target="_blank" title="Emory Alumni Association"&gt;Emory Alumni Association&lt;/a&gt;&lt;/li&gt;
							&lt;/ul&gt;
						&lt;/div&gt;
					&lt;/div&gt;
				&lt;/li&gt;
				&lt;li class="topLevel"&gt;
					&lt;a class="utilLink" title="Libraries"&gt;&lt;span&gt;Libraries&lt;/span&gt;&lt;/a&gt;
					&lt;div class="flyOut"&gt;
						&lt;div class="col col1"&gt;
							&lt;h4&gt;Libraries&lt;/h4&gt;
							&lt;ul&gt;
								...
								&lt;li&gt;&lt;a href="http://web.library.emory.edu/libraries/james-s-guy-chemistry-library" target="_blank" title="Chemistry"&gt;Chemistry&lt;/a&gt;&lt;/li&gt;
								...
								&lt;li&gt;&lt;a href="http://web.library.emory.edu/libraries/music-and-media" target="_blank" title="Music and Media"&gt;Music &amp;amp; Media&lt;/a&gt;&lt;/li&gt;
						...
						&lt;div class="col col2"&gt;
							...
							&lt;ul&gt;
								...
								&lt;li&gt;&lt;a href="http://web.library.emory.edu/databases/" target="_blank" title="Databases"&gt;Databases&lt;/a&gt;&lt;/li&gt;
								&lt;li&gt;&lt;a href="http://digitalscholarship.emory.edu/" target="_blank" title="Digital Scholarship (ECDS)"&gt;Digital Scholarship (ECDS)&lt;/a&gt;&lt;/li&gt;
								...
								&lt;li&gt;&lt;a href="http://www.library.emory.edu/" target="_blank" title="EUCLID (Library Catalog)"&gt;EUCLID&lt;/a&gt;&lt;/li&gt;
				...
				&lt;/li&gt;
				&lt;li class="topLevel"&gt;
					&lt;a class="utilLink" title="Schools"&gt;&lt;span&gt;Schools&lt;/span&gt;&lt;/a&gt;
					&lt;div class="flyOut"&gt;
						&lt;div class="col col1"&gt;
							&lt;h4&gt;Undergraduate&lt;/h4&gt;
							&lt;ul&gt;
								&lt;li&gt;&lt;a href="http://college.emory.edu/" target="_blank" title="Emory College"&gt;Emory College&lt;/a&gt;&lt;/li&gt;
								&lt;li&gt;&lt;a href="/" title="Oxford College"&gt;Oxford College&lt;/a&gt;&lt;/li&gt;
								&lt;li&gt;&lt;a href="http://goizueta.emory.edu/" target="_blank" title="Business School"&gt;Business School&lt;/a&gt;&lt;/li&gt;
								&lt;li&gt;&lt;a href="http://nursing.emory.edu/" target="_blank" title="School of Nursing"&gt;School of Nursing&lt;/a&gt;&lt;/li&gt;
							&lt;/ul&gt;
							&lt;h4&gt;Community&lt;/h4&gt;
							&lt;ul&gt;
								&lt;li&gt;&lt;a href="http://ece.emory.edu/" target="_blank" title="Emory Continuing Education"&gt;Emory Continuing Education&lt;/a&gt;&lt;/li&gt;
								...
								&lt;li&gt;&lt;a href="http://college.emory.edu/precollege/" target="_blank" title="Pre-College Program"&gt;Pre-College Program&lt;/a&gt;&lt;/li&gt;
							&lt;/ul&gt;
						&lt;/div&gt;
						&lt;div class="col col2"&gt;
							&lt;h4&gt;Graduate&lt;/h4&gt;
							&lt;ul&gt;
								&lt;li&gt;&lt;a href="http://goizueta.emory.edu/" target="_blank" title="Business School"&gt;Business School&lt;/a&gt;&lt;/li&gt;
								&lt;li&gt;&lt;a href="http://graduateschool.emory.edu/" target="_blank" title="Graduate School"&gt;Graduate School&lt;/a&gt;&lt;/li&gt;
								&lt;li&gt;&lt;a href="http://law.emory.edu/" target="_blank" title="School of Law"&gt;School of Law&lt;/a&gt;&lt;/li&gt;
								&lt;li&gt;&lt;a href="http://med.emory.edu/" target="_blank" title="School of Medicine"&gt;School of Medicine&lt;/a&gt;&lt;/li&gt;
								&lt;li&gt;&lt;a href="http://nursing.emory.edu/" target="_blank" title="School of Nursing"&gt;School of Nursing&lt;/a&gt;&lt;/li&gt;
								&lt;li&gt;&lt;a href="http://sph.emory.edu/" target="_blank" title="School of Public Health"&gt;School of Public Health&lt;/a&gt;&lt;/li&gt;
								&lt;li&gt;&lt;a href="http://candler.emory.edu/" target="_blank" title="School of Theology"&gt;School of Theology&lt;/a&gt;&lt;/li&gt;
							&lt;/ul&gt;
						&lt;/div&gt;
					&lt;/div&gt;
				&lt;/li&gt;
				&lt;li class="topLevel"&gt;
					&lt;a class="utilLink" title="Resources"&gt;&lt;span&gt;Oxford Resources&lt;/span&gt;&lt;/a&gt;
					&lt;div class="flyOut"&gt;
						&lt;div class="col col1"&gt;
							&lt;h4&gt;Oxford Resources&lt;/h4&gt;
							&lt;ul&gt;
								&lt;li&gt;&lt;a href="https://app.oxford.emory.edu/WebApps/Directories/index.cfm" title="Directory"&gt;Directory&lt;/a&gt;&lt;/li&gt;
								&lt;li&gt;&lt;a href="http://oxford.library.emory.edu/" target="_blank" title="Library"&gt;Library&lt;/a&gt;&lt;/li&gt;
								&lt;li&gt;&lt;a href="http://oxford.emory.edu/events-calendar/" title="Events Calendar"&gt;Events Calendar&lt;/a&gt;&lt;/li&gt;
		...
		&lt;footer id="footer" class="row"&gt;
			&lt;!-- Icon bar on narrow screens --&gt;
			&lt;div id="footerIconBar" class="row"&gt;
				&lt;div class="col-xs-6"&gt;&lt;a id="contactMenu" href="http://oxford.emory.edu/a-distinctive-place/contact-oxford/"&gt;&lt;i class="fa fa-pencil fa-2x"&gt;&lt;/i&gt;&lt;/a&gt;&lt;/div&gt;
				&lt;div class="col-xs-6"&gt;&lt;a id="mapsMenu" href="http://oxford.emory.edu/visit-oxford/maps-and-directions/"&gt;&lt;i class="fa fa-map-marker fa-2x"&gt;&lt;/i&gt;&lt;/a&gt;&lt;/div&gt;
				&lt;div class="col-xs-6"&gt;&lt;a id="feedbackMenu" href="https://app.oxford.emory.edu/WebApps/OCIT/forms/AskIT/"&gt;&lt;i class="fa fa-comment-o fa-2x"&gt;&lt;/i&gt;&lt;/a&gt;&lt;/div&gt;
				&lt;div class="col-xs-6"&gt;&lt;a id="emergencyMenu" href="http://oxford.emory.edu/life-at-oxford/campus-police/emergency-contacts/"&gt;&lt;i class="fa fa-warning fa-2x"&gt;&lt;/i&gt;&lt;/a&gt;&lt;/div&gt;
			&lt;/div&gt;
			&lt;div class="col-sm-18" id="footLinks"&gt;
				&lt;ul&gt;
					&lt;li&gt;&lt;a href="http://oxford.emory.edu/a-distinctive-place/contact-oxford/" title="Contact Oxford"&gt;CONTACT OXFORD&lt;/a&gt;&lt;span&gt;|&lt;/span&gt;&lt;/li&gt;
					&lt;li&gt;&lt;a href="https://app.oxford.emory.edu/WebApps/OCIT/forms/AskIT/" title="Website Feedback"&gt;WEBSITE FEEDBACK&lt;/a&gt;&lt;span&gt;|&lt;/span&gt;&lt;/li&gt;
					&lt;li&gt;&lt;a href="http://oxford.emory.edu/life-at-oxford/campus-police/emergency-contacts/" title="Emergency"&gt;EMERGENCY&lt;/a&gt;&lt;span&gt;|&lt;/span&gt;&lt;/li&gt;
					&lt;li&gt;&lt;a href="http://oxford.emory.edu/operations/human-resources/employment/job-opportunities/" title="Employment"&gt;EMPLOYMENT&lt;/a&gt;&lt;span&gt;|&lt;/span&gt;&lt;/li&gt;
					&lt;li&gt;&lt;a href="http://www.emory.edu" target="_blank" title="Emory Home"&gt;EMORY HOME&lt;/a&gt;&lt;span class="notAlwaysNeeded"&gt;|&lt;/span&gt;&lt;/li&gt;
					&lt;li class="notAlwaysNeeded"&gt;&lt;a href="http://directory.service.emory.edu/" target="_blank" title="Emory Directory"&gt;EMORY DIRECTORY&lt;/a&gt;&lt;/li&gt;
				&lt;/ul&gt;
				&lt;div id="footSubtext"&gt;
					&lt;div&gt;
						&lt;span&gt;Copyright &amp;#169; 2014 &lt;a href="/"&gt;Oxford College&lt;/a&gt; of &lt;a href="http://www.emory.edu/"&gt;Emory University&lt;/a&gt;&lt;/span&gt;
						&lt;span id="footBreak"&gt;-&lt;/span&gt;
						&lt;span&gt;All Rights Reserved&lt;/span&gt;
						&lt;span class="notAlwaysNeeded"&gt;|&lt;/span&gt;
					&lt;/div&gt;
					&lt;div&gt;
						110 Few Circle, Oxford, GA 30054 | 770.784.8888
					&lt;/div&gt;
				&lt;/div&gt; &lt;!-- /footSubtext --&gt;
			&lt;/div&gt; &lt;!-- /footLinks --&gt;
			&lt;div id="mediaFooter" class="col-sm-6 mediabtnsNav"&gt;
				&lt;div class="row SMmenu"&gt;
					&lt;div class="col-sm-3 FacebookNav"&gt;&lt;a href="http://www.facebook.com/pages/Oxford-GA/Oxford-College-of-Emory-University/81895437026" target="_blank" title="Facebook"&gt;&lt;span&gt;Facebook&lt;/span&gt;&lt;/a&gt;&lt;/div&gt;
					&lt;div class="col-sm-3 TwitterNav"&gt;&lt;a href="http://twitter.com/OxfordCollege" target="_blank" title="Twitter"&gt;&lt;span&gt;Twitter&lt;/span&gt;&lt;/a&gt;&lt;/div&gt;
					&lt;div class="col-sm-3 YoutubeNav"&gt;&lt;a href="http://www.youtube.com/EmoryUniversity" target="_blank" title="Youtube"&gt;&lt;span&gt;Youtube&lt;/span&gt;&lt;/a&gt;&lt;/div&gt;
					&lt;div class="col-sm-3 InstagramNav"&gt;&lt;a href="http://instagram.com/oxfordcollege" target="_blank" title="Instagram"&gt;&lt;span&gt;Instagram&lt;/span&gt;&lt;/a&gt;&lt;/div&gt;
					&lt;div class="col-sm-3 FlickrNav"&gt;&lt;a href="http://www.flickr.com/photos/oxfordcollege/show/" target="_blank" title="Flickr"&gt;&lt;span&gt;Flickr&lt;/span&gt;&lt;/a&gt;&lt;/div&gt;
					&lt;div class="col-sm-3 BlogNav"&gt;&lt;a href="https://blogs.emory.edu/admissionblog/" target="_blank" title="Oxford Blog"&gt;&lt;span&gt;Oxford Blog&lt;/span&gt;&lt;/a&gt;&lt;/div&gt;
					&lt;div class="col-sm-3 iTunesNav"&gt;&lt;a href="http://www.itunes.emory.edu/" target="_blank" title="iTunes"&gt;&lt;span&gt;iTunes&lt;/span&gt;&lt;/a&gt;&lt;/div&gt;
					&lt;div class="col-sm-3 MobileNav"&gt;&lt;a href="http://www.emory.edu/mobile/" target="_blank" title="Mobile"&gt;&lt;span&gt;Mobile&lt;/span&gt;&lt;/a&gt;&lt;/div&gt;
				&lt;/div&gt;
			&lt;/div&gt; &lt;!-- /mediabtnsNav --&gt;
		&lt;/footer&gt;
	&lt;/div&gt; &lt;!-- /Container --&gt;
	&lt;!--## Google Analytics --&gt;
		...
		&lt;script&gt;
			try {
				var pageTracker = _gat._getTracker("UA-23972000-1");
				pageTracker._trackPageview();
				var secondTracker = _gat._getTracker("UA-1875823-4");
...
<select name="site">
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='CRDR')]">
   <option value="CRDR" selected="selected">CRDR</option>
  </xsl:when>
  <xsl:otherwise>
 ...
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='emoryhealthcare_v2')]">
   <option value="emoryhealthcare_v2" selected="selected">emoryhealthcare_v2</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="emoryhealthcare_v2">emoryhealthcare_v2</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
 ...
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='inside_oxford')]">
   <option value="inside_oxford" selected="selected">inside_oxford</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="inside_oxford">inside_oxford</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
 ...
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='isss')]">
   <option value="isss" selected="selected">isss</option>
  </xsl:when>
  <xsl:otherwise>
 ...
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='it_CRD')]">
   <option value="it_CRD" selected="selected">it_CRD</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="it_CRD">it_CRD</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
 ...
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='library-sco')]">
   <option value="library-sco" selected="selected">library-sco</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="library-sco">library-sco</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
 ...
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='mail_crdr')]">
   <option value="mail_crdr" selected="selected">mail_crdr</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="mail_crdr">mail_crdr</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
 ...
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='oxford_cat')]">
   <option value="oxford_cat" selected="selected">oxford_cat</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="oxford_cat">oxford_cat</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
 ...
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='registrar')]">
 ...
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='researchdata')]">
   <option value="researchdata" selected="selected">researchdata</option>
  </xsl:when>
  <xsl:otherwise>
  ...
  <xsl:param name="time"/>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="{$sep_bar_bg_color}">
			<tr>
              ...
              Search took 
							<span style="font-weight: bold;" id="search_time">
