...
<xsl:variable name="search_button_text">Emory Search</xsl:variable>
...
<!-- *** page title *** -->
<xsl:variable name="front_page_title">Emory University | Atlanta, GA | Search Home</xsl:variable>
<xsl:variable name="result_page_title">Emory University | Atlanta, GA | Search Results</xsl:variable>
<xsl:variable name="adv_page_title">Emory University | Atlanta, GA | Advanced Search</xsl:variable>
<xsl:variable name="error_page_title">Emory University | Atlanta, GA | Error</xsl:variable>
<xsl:variable name="swr_page_title">Emory University | Atlanta, GA | Search Within Results</xsl:variable>
...
<xsl:template name="no_RES">
  ...
  <xsl:if test="$egds_show_desktop_results != '0'">
    <div class="main-content"><div class="wysiwyg">
...
<xsl:template name="js">
	...
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.8.1/jquery.min.js" type="text/javascript" xml:space="preserve"/>
	<script src="https://ajax.googleapis.com/ajax/libs/jqueryui/1.8.23/jquery-ui.min.js" type="text/javascript" xml:space="preserve"/>
	<script src="//www.emory.edu/home/_includes/js/emory-feed-local-API.js" type="text/javascript" xml:space="preserve"/>
	<script src="//www.emory.edu/home/_includes/js/emory-typekit.js" type="text/javascript" xml:space="preserve"/>
	<script src="//www.emory.edu/home/_includes/js/emory-jquery-plugin-utilityNav.js" type="text/javascript" xml:space="preserve"/>
	<script src="//www.emory.edu/home/_includes/js/emory-jquery-search.js" type="text/javascript" xml:space="preserve"/>
	<script src="//www.emory.edu/home/_includes/js/emory-jquery-random-callouts.js" type="text/javascript" xml:space="preserve"/>
	<script src="//www.emory.edu/home/_includes/js/jquery-ga-0.3.8.min.js" type="text/javascript" xml:space="preserve"/>
	<script src="//www.emory.edu/home/_includes/js/emory-jquery-ga.js" type="text/javascript" xml:space="preserve"/>
	<script type="text/javascript">$(document).ready(function(){     $('#utility-navigation').emoryUtilityMenu();$('#top').find('input[type=submit]').button();});</script>    
</xsl:template>
<!-- **********************************************************************
...
<xsl:template name="meta">
	<meta content="Copyright © 2013 Emory University - All Rights Reserved" name="copyright"/>
	<meta content="width=device-width, initial-scale=1.0" name="viewport"/>
	<meta content="false" name="imagetoolbar"/>
	<meta content="true" name="MSSmartTagsPreventParsing"/>
	<meta content="0jwNCeujjk2bSSoAuJ1BEOLK43eKj9sTlJNmSSHnA1E=" name="verify-v1"/>
	<meta content="Cascade Server" name="generator"/>
	<meta content="university" property="og:type"/>
	<meta content="//www.emory.edu/home/_includes/images/system/fb-emory.gif" property="og:image"/>
</xsl:template>
<!-- **********************************************************************
	...
	<style media="all" type="text/css">
		<xsl:text>/*</xsl:text>
			<xsl:comment>
				<xsl:text>*/</xsl:text>
				<xsl:text>
					@import url('//www.emory.edu/home/_includes/css/emory-html5-fix.css');
					@import url('//www.emory.edu/home/_includes/css/jquery-ui-main/jquery-ui-1.8.23.emory-main.css');
					@import url('//www.emory.edu/home/_includes/css/emory-main-base.css');
					@import url('//www.emory.edu/home/_includes/css/emory-main-nav.css');
					@import url('//www.emory.edu/home/_includes/css/emory-main-header-footer.css');
					@import url('//www.emory.edu/home/_includes/css/emory-interior-common.css');
					@import url('//www.emory.edu/home/_includes/css/emory-callouts.css');
					@import url('//www.emory.edu/home/_includes/css/emory-special-two-column.css');
				</xsl:text>
				<xsl:text>/*</xsl:text>
			</xsl:comment>
		<xsl:text>*/</xsl:text>
	...
	<style media="all" type="text/css">
		<xsl:text>/*</xsl:text>
			<xsl:comment>
				...
				<xsl:text>
					.search-box{}
					.search-box .search-row-item{float:left;margin-right:5px; height: 30px; text-align:left;}
					.search-box .search-row-item input.text{height: 21px;font-size: 17px;padding-left: 5px;}
...
<xsl:template name="emory_wrapper">
	...
	<div class="container" id="container-shadow">
		<div class="container" id="container">
			...
			<xsl:call-template name="emory_after_header" />
			<section id="html5-top">
				<div id="top">
					<xsl:comment>Level 20.50.40.00.00</xsl:comment>
					<div class="left">
						<xsl:comment>Level 20.50.40.10.00</xsl:comment>
					</div>
					<div class="center">
						<xsl:comment>Level 20.50.40.50.00</xsl:comment>
						<article id="Search">
							<div>
					...
					<div class="right">
						<xsl:comment>Level 20.50.40.90.00</xsl:comment>
			...
			<xsl:call-template name="emory_bottom" />
			<xsl:call-template name="emory_above_footer" />
			<xsl:call-template name="emory_footer" />
		</div>
	</div>
</xsl:template>

<xsl:template name="right-rail-news-events-tabs">
<div class="right-rail-content"><script type="text/javascript">
            $(document).ready(function() {
                $( "#tabs409691" ).tabs({create: function(event, ui) { /* Fix for WebKit draw*/  $(this).find('.ui-tabs-panel').hide().show();}});
                            });
        </script><!-- jQuery Tabs --><section class="jquery-tabs"><div class="jquery-tabs tabs-top" id="tabs409691"><ul><li><a href="#tabs409691-1">News</a></li><li><a href="#tabs409691-2">Events</a></li></ul><div id="tabs409691-1"><script type="text/javascript">
            $(document).ready(function () {
            

            $('#emory-right-rail').emoryFeed({
                        preset: "2 - Emory Right Rail",
                        url: "//news.emory.edu/index_atom.xml",
                        title: {linkURL:'http://news.emory.edu', text: "Today\'s News \xBB"},
                        viewAll: {linkURL:"http://news.emory.edu", text:"More News \xBB"}
                
             }); 

            });
</script><div class="emory-feed right-rail" id="emory-right-rail"></div></div><div id="tabs409691-2"><div class="right-rail emory-feed"><h2 class="header"><a href="http://www.emory.edu/home/events">Events &#187;</a></h2><!-- closes .featured-event --><div class="trumba-spud">
<script src="//www.trumba.com/scripts/spuds.js" type="text/javascript"></script><script type="text/javascript">
$Trumba.addSpud({
webName: "_Emory-edu-Homepage",
spudType : "upcomingphoto" ,
spudConfig : "NewsCenter" ,
teaserBase : "http://www.trumba.com/calendars/_Emory-edu-Homepage" });
</script></div><!-- closes #trumba-spud --><p class="view-all"><a href="http://www.emory.edu/home/events">More Events &#187;</a></p></div></div></div></section></div>

</xsl:template>

<xsl:template name="right-rail-social-media-links">
<div class="right-rail-content">
	<!-- Social Media Link Set -->
	<section class="social-media-link-set-section">
		<div class="social-media-link-set">
			<h2 class="header">Connect with Emory</h2>
			<a href="http://www.facebook.com/EmoryUniversity" target="_blank" title="Facebook">
				<img alt="Facebook" src="http://www.emory.edu/home/_includes/images/system/social-media-15/facebook.jpg"/>
				<span> Facebook</span>
			</a>
			<a href="http://www.youtube.com/EmoryUniversity" target="_blank" title="YouTube">
				<img alt="YouTube" src="http://www.emory.edu/home/_includes/images/system/social-media-15/youtube.jpg"/>
				<span> YouTube</span>
			</a>
			<a href="http://twitter.com/EmoryUniversity" target="_blank" title="Twitter">
				<img alt="Twitter" src="http://www.emory.edu/home/_includes/images/system/social-media-15/twitter.jpg"/>
				<span> Twitter</span>
			</a>
			<a href="http://itunes.emory.edu/" target="_blank" title="iTunes U">
				<img alt="iTunes U" src="http://www.emory.edu/home/_includes/images/system/social-media-15/itunes.jpg"/>
				<span> iTunes U</span>
			</a>
			<a href="http://m.emory.edu/" target="_blank" title="Emory Mobile">
				<img alt="Emory Mobile" src="http://www.emory.edu/home/_includes/images/system/social-media-15/mobile.jpg"/>
				<span> Emory Mobile</span>
			</a>
			<a href="https://plus.google.com/u/0/112370123330553516746/posts?prsrc=3" target="_blank" title="Google+">
				<img alt="Google+" src="http://www.emory.edu/home/_includes/images/system/social-media-15/gplus.jpg"/>
				<span> Google+</span>
			</a>
		</div>
	</section>
...
<xsl:template name="emory_bottom">
	<section id="html5-bottom">
		<div id="bottom">
				<xsl:comment>Level 20.50.60.00.00</xsl:comment>
			<div class="left">
				<xsl:comment>Level 20.50.60.10.00</xsl:comment>
			</div>
			<div class="center">
				<xsl:comment>Level 20.50.60.50.00</xsl:comment>
			</div>
			<div class="right">
				<xsl:comment>Level 20.50.60.90.00</xsl:comment>
			</div>
		</div>
	</section>
</xsl:template>

<xsl:template name="emory_above_footer">
...
<xsl:template name="emory_footer">
  <footer id="html5-footer">
    <div id="footer">
      <!-- Level 20.50.90.00.00. -->
      <div class="mega-links-container">
        <nav aria-label="Schools" class="col-md-4">
          <span class="lead">Schools</span>
          <div class="row eq-height-row">
            <div class="col-sm-6">
              <span>Undergraduate</span>
              <small>
                <ul>
                  <li><a href="http://www.college.emory.edu/" target="_blank">Emory College</a></li>
                  <li><a href="http://oxford.emory.edu/" target="_blank">Oxford College</a></li>
                  <li><a href="http://goizueta.emory.edu/" target="_blank">Business School</a></li>
                  <li><a href="http://www.nursing.emory.edu/" target="_blank">School of Nursing</a></li>
                </ul>
              </small>
              <span>Community</span>
              <small>
                <ul>
                  <li><a href="http://www.ece.emory.edu/" target="_blank">Emory Continuing Education</a></li>
                  <li><a href="http://www.emory.edu/home/academics/continuing-education.html" target="_self">Professional Education</a></li>
                  <li><a href="http://precollege.emory.edu/" target="_blank">Pre-College Program</a></li>
                </ul>
              </small>
            </div>
            <div class="col-sm-6">
              ...
              <small>
                <ul>
                  <li><a href="http://goizueta.emory.edu/" target="_blank">Business School</a></li>
                  <li><a href="http://www.gs.emory.edu/" target="_blank">Graduate School</a></li>
                  <li><a href="http://www.law.emory.edu/" target="_blank">School of Law</a></li>
                  <li><a href="http://www.med.emory.edu/" target="_blank">School of Medicine</a></li>
                  <li><a href="http://www.nursing.emory.edu/" target="_blank">School of Nursing</a></li>
                  <li><a href="http://www.sph.emory.edu/" target="_blank">School of Public Health</a></li>
                  <li><a href="http://www.candler.emory.edu/" target="_blank">School of Theology</a></li>
                </ul>
              </small>
            </div>
          </div>
        </nav>
        <nav aria-label="Libraries and Tools" class="col-md-4">
          <span class="lead">Libraries and Tools</span>
          <div class="row eq-height-row">
            <div class="col-sm-6">
              <span>Libraries</span>
              <small>
                <ul>
                  <li><a href="http://web.library.emory.edu/" target="_blank">Robert W. Woodruff</a></li>
                  <li><a href="http://business.library.emory.edu/" target="_blank">Business</a></li>
                  <li><a href="http://web.library.emory.edu/about/libraries/other-libraries/chemistry-library/" target="_blank">Science Commons</a></li>
                  <li><a href="http://health.library.emory.edu/" target="_blank">Health Sciences</a></li>
                  <li><a href="http://library.law.emory.edu/" target="_blank">Law</a></li>
                  <li><a href="http://web.library.emory.edu/about/libraries/woodruff-building/music-media-library.html" target="_blank">Music &amp; Media</a></li>
                  <li><a href="http://oxford.library.emory.edu" target="_blank">Oxford College</a></li>
                  <li><a href="http://rose.library.emory.edu/" target="_blank">Rose Library</a></li>
                  <li><a href="http://www.pitts.emory.edu/" target="_blank">Theology</a></li>
                </ul>
              </small>
            </div>
            <div class="col-sm-6">
              ...
              <small>
                <ul>
                  <li><a href="https://ereserves.library.emory.edu/reserves2/index.php" target="_blank">Course Reserves</a></li>
                  <li><a href="http://digitalscholarship.emory.edu/" target="_blank">Digital Scholarship (ECDS)</a></li>
                  <li><a href="http://discovere.emory.edu" target="_blank">discoverE</a></li>
                  <li><a href="http://ejournals.emory.edu/" target="_blank">eJournals</a></li>
                  <li><a href="https://etd.library.emory.edu/" target="_blank">Electronic Dissertations</a></li>
                  <li><a href="http://findingaids.library.emory.edu/" target="_blank">EmoryFindingAids</a></li>
                  <li><a href="http://www.library.emory.edu/uhtbin/nph-illiad" target="_blank">ILLiad</a></li>
                  <li><a href="https://open.library.emory.edu/" target="_blank">OpenEmory</a></li>
                  <li><a href="http://guides.main.library.emory.edu/" target="_blank">Research Guides</a></li>
                </ul>
              </small>
            </div>
          </div>
        </nav>
        <nav aria-label="Resources" class="col-md-4">
          <span class="lead">Resources</span>
          <div class="row eq-height-row">
            <div class="col-sm-6">
              <small>
                <ul>
                  <li><a href="http://www.emory.edu/home/about/administration/index.html" target="_self">Administrative Offices</a></li>
                  <li><a href="http://www.emoryhealthcare.org/" target="_blank">Emory Healthcare</a></li>
                  <li><a href="http://registrar.emory.edu/Students/Calendars/" target="_blank">Academic Calendars</a></li>
                  <li><a href="http://www.bookstore.emory.edu/" target="_blank">Bookstore</a></li>
                  <li><a href="http://map.emory.edu/" target="_blank">Campus Maps</a></li>
                  <li><a href="http://transportation.emory.edu/" target="_blank">Shuttles and Parking</a></li>
                  <li><a href="http://www.emoryathletics.com/" target="_blank">Athletics: Emory Eagles</a></li>
                  <li><a href="http://www.arts.emory.edu" target="_blank">Arts at Emory</a></li>
                  <li><a href="http://www.carlos.emory.edu/" target="_blank">Michael C. Carlos Museum</a></li>
                  <li><a href="http://news.emory.edu/" target="_blank">Emory News Center</a></li>
                  <li><a href="http://news.emory.edu/campus/index.html" target="_blank">Emory Report</a></li>
                </ul>
              </small>
            </div>
            <div class="col-sm-6">
              <small>
                <ul>
                  <li><a href="http://www.emory.edu/home/emergency/index.html" target="_self">Emergency Contacts</a></li>
                  <li><a href="http://www.it.emory.edu/" target="_blank">Information Technology (IT)</a></li>
                  <li><a href="http://email.emory.edu/" target="_blank">Office 365 Web Access</a></li>
                  <li><a href="http://it.emory.edu/office365/" target="_blank">Office 365</a></li>
                  <li><a href="https://classes.emory.edu" target="_blank">Canvas</a></li>
                  <li><a href="https://www.opus.emory.edu" target="_blank">OPUS</a></li>
                  <li><a href="https://compass-login.emory.edu/" target="_blank">PeopleSoft Financials: Compass</a></li>
                  <li><a href="http://www.hr.emory.edu/eu/careers/" target="_blank">Careers</a></li>
                  <li><a href="http://www.hr.emory.edu/eu/" target="_blank">Human Resources</a></li>
                  <li><a href="http://www.alumni.emory.edu/" target="_blank">Emory Alumni Association</a></li>
                  <li><a href="https://dwbi.emory.edu/analytics/" target="_blank">Emory Business Intelligence</a></li>
                </ul>
              </small>
            </div>
          </div>
      ...
      <nav id="html5-footer-link-set">
        <ul id="footer-link-set">
          <li class="footer-link-item first"><a href="index.html" target="_self">Emory Home</a></li>
          <li class="footer-link-item "><a href="contact-emory/index.html" target="_self">Contacts</a></li>
          <li class="footer-link-item "><a href="emergency/index.html" target="_self">Emergency</a></li>
          ...
          <li class="footer-link-item last"><a href="life/social-media/index.html" target="_self">Social Media</a></li>
        </ul>
      </nav>
        ...
        <div id="footer-copyright-and-address">
          <section id="html5-footer-copyright">
            <div id="footer-copyright">
              <a href="http://communications.emory.edu/tools/web-guide/copyright-dmca.html" title="copyright"><span id="footer-copyright-info">Copyright  &#169; </span></a>
              ...
              <a href="index.html"><span id="footer-copyright-owner">Emory University</span></a><span id="footer-copyright-rights"> - All Rights Reserved</span>
            </div>
          </section>
      ...
      <div class="footer watermak desktop-only"><a href="http://www.emoryhealthcare.org" target="_blank" title="Emory Healthcare"><img alt="Emory Healthcare" src="//www.emory.edu/home/_includes/images/page-parts/footer/emory-healthcare.gif"/></a></div>
      <div class="helper-clearfix"></div>
    </div>
  </footer>
...
<xsl:template name="emory_footer_footer_link_set">
	<nav id="html5-footer-link-set">
		<ul id="footer-link-set">
			<li class="footer-link-item first">
				<a href="http://www.emory.edu/home/index.html" target="_self">Emory Home</a>
			</li>
			<li class="footer-link-item ">
				<a href="http://www.emory.edu/home/contact-emory/index.html" target="_self">Contacts</a>
			</li>
			<li class="footer-link-item ">
				<a href="http://www.emory.edu/home/emergency/index.html" target="_self">Emergency</a>
			</li>
			<li class="footer-link-item ">
				<a href="http://www.hr.emory.edu/eu/careers/" target="_blank">Careers</a>
			</li>
			<li class="footer-link-item ">
				<a href="http://www.emory.edu/home/about-this-site/index.html" target="_self">Emory's Web</a>
			</li>
			<li class="footer-link-item ">
				<a href="http://www.emory.edu/home/life/social-media/index.html" target="_self">Social Media</a>
			</li>
<!-- 
			<li class="footer-link-item ">
				<a href="http://www.emory.edu/home/about-this-site/a-z-index.html" target="_self">A-Z</a>
			</li>
			<li class="footer-link-item last">
				<a href="http://www.emory.edu/home/about-this-site/site-map.html" target="_self">Site Map</a>
			</li>
 -->
		</ul>
	</nav>
...
<xsl:template name="emory_footer_copyright_address">
	<section id="html5-footer-copyright-and-address">
		<div id="footer-copyright-and-address">
			<section id="html5-footer-copyright">
				<div id="footer-copyright">
					<a href="http://www.emory.edu/home/about-this-site/copyright.html" title="copyright">
						<span id="footer-copyright-info">Copyright  © </span>
					</a>
					<span id="footer-copyright-year">
					...
					<a href="http://www.emory.edu/home/index.html">
						<span id="footer-copyright-owner">Emory University</span>
					</a>
					<span id="footer-copyright-rights"> - All Rights Reserved</span>
				</div>
			</section>
			<section id="html5-footer-address">
				<div id="footer-address">
					<span>201 Dowman Drive, Atlanta, Georgia 30322 USA 404.727.6123</span>
				</div>
			</section>
		</div>
	</section>
...
<xsl:template name="emory_footer_watermark">
	<style media="all" type="text/css" xml:space="preserve">.footer.watermak{    position:absolute;    top:10px;    left:810px;}</style>
	<div class="footer watermak desktop-only">
		<a href="http://www.emoryhealthcare.org" target="_blank" title="Emory Healthcare">
			<img alt="Emory Healthcare" src="https://www.emory.edu/home/_includes/images/page-parts/footer/emory-healthcare.gif"/>
		</a>
	</div>
</xsl:template>

<xsl:template name="emory_after_header">
	<section id="html5-after-header">
		<div id="after-header">
			<xsl:call-template name="emory_after_header_emergency-announcements" />
			<xsl:call-template name="emory_after_header_subject_nav" />
		</div>
	</section>
</xsl:template>

<xsl:template name="emory_after_header_emergency-announcements">
	<section id="html5-emergency-announcements">
		<div id="emergency-announcements">
			<script language="javascript" src="//www.emory.edu/template_shared/emergency_include.js" type="text/javascript"/>
		</div>
	</section>
</xsl:template>

<xsl:template name="emory_after_header_subject_nav">
  <nav id="html5-subject-navigation">
    <!--[if IE 8]><div class="html5-subject-navigation"><![endif]-->
    <!--[if lt IE 8]><table class="html5-subject-navigation subject-navigation"><![endif]-->
    <!--[if lt IE 8]><tr style="display:none"><td><![endif]-->
    <div class="nav-items-6" id="subject-navigation">
      <!--[if lt IE 8]></div></td></tr><![endif]-->
      <!--[if lt IE 8]><td><![endif]-->
      <a class="" href="http://www.emory.edu/home/about/index.html" target="_self" title="About Emory">
        <div class="subject-navigation-item">About Emory</div>
        <div class="subject-navigation-item ie-shadow">About Emory</div>
      </a>
      <!--[if lt IE 8]></td><td class=""><![endif]-->
      <a class="" href="http://www.emory.edu/home/admission/index.html" target="_self" title="Admission &amp; Aid">
        <div class="subject-navigation-item">Admission &amp; Aid</div>
        <div class="subject-navigation-item ie-shadow">Admission &amp; Aid</div>
      </a>
      <!--[if lt IE 8]></td><td class=""><![endif]-->
      <a class="" href="http://www.emory.edu/home/academics/index.html" target="_self" title="Academics">
        <div class="subject-navigation-item">Academics</div>
        <div class="subject-navigation-item ie-shadow">Academics</div>
      </a>
      <!--[if lt IE 8]></td><td class=""><![endif]-->
      <a class="" href="http://www.emory.edu/home/research/" target="_self" title="Research">
        <div class="subject-navigation-item">Research</div>
        <div class="subject-navigation-item ie-shadow">Research</div>
      </a>
      <!--[if lt IE 8]></td><td class=""><![endif]-->
      <a class="" href="http://www.emory.edu/home/life/index.html" target="_self" title="Life at Emory">
        <div class="subject-navigation-item">Life at Emory</div>
        <div class="subject-navigation-item ie-shadow">Life at Emory</div>
      </a>
      <!--[if lt IE 8]></td><td class=""><![endif]-->
      <a class=" last" href="http://www.emory.edu/home/giving/index.html" target="_self" title="Give to Emory">
        <div class="subject-navigation-item">Give to Emory</div>
        <div class="subject-navigation-item ie-shadow">Give to Emory</div>
      </a>
      <!--[if lt IE 8]></td><![endif]-->
      <!--[if lt IE 8]></tr><![endif]-->
      <!--[if lt IE 8]><tr style="display:none"><td><div><![endif]-->
    </div>
    <!--[if lt IE 8]></td></tr><![endif]-->
    <!--[if IE 8]></div><![endif]-->
...
<xsl:template name="emory_header">
  <header id="html5-header">
    <div id="header">
      <!-- Level 20.50.10.00.00 -->
      <nav id="html5-utility-navigation">
        <ul id="utility-navigation">
          <li class="utility-nav-top-level utility-nav-top-level-search utility-nav-search-on-page">
            <div class="utility-nav-flyOut-search">
              <form name="searchForm" onsubmit="$.emory.startSearch();">
                <input name="q" type="hidden"/>
                <fieldset class="search-two-items utility-nav-search-choices">
                  <legend style="display: none;">Search in Emory Sites or People Directory</legend>
                  <input class="search-radio" id="directory" name="searchType" type="radio" value="directory"/><label for="directory">Emory Sites</label><input class="search-radio" id="people" name="searchType" type="radio" value="people"/><label for="people">People Directory</label>
                </fieldset>
                <div class="utility-nav-search-bar"><label for="searchInput" style="display: none;">Search Form</label><input class="searchInput" id="searchInput" name="searchString" size="20" type="text"/><input alt="search" class="searchBtn" src="//www.emory.edu/home/_includes/images/system/search-btn.gif" type="image"/><input name="client" type="hidden" value="default_frontend"/><input name="output" type="hidden" value="xml_no_dtd"/><input name="filter" type="hidden" value="0"/><input name="proxystylesheet" type="hidden" value="homepage"/><input name="site" type="hidden" value="default_collection"/></div>
              </form>
            </div>
          </li>
        </ul>
      ...
      <div class="unit-signature-container">
        <div class="position-element">
          <img alt="Emory University Logo" class="unit-signature-image" src="//www.emory.edu/home/_includes/images/system/university-logo-high-res.png"/>
          <div class="unit-signature-links">
            <a href="index.html" target="_self">
              <div onclick="top.location.href='index.html'" style="width:240px">index.html</div>
            </a>
          </div>
        </div>
      </div>
      ...
      <div class="header watermak desktop-only">
        <img alt="Atlanta" src="//www.emory.edu/home/_includes/images/page-parts/header/atlanta.gif"/>
      </div>
    </div>
  </header>
</xsl:template>

<xsl:template name="styleOld">
<style>
<xsl:comment>
...
<xsl:variable name="html_escaped_as_eq">
			...
			<section class="content-column-full">
				<div class="column-full column-standard column-last ">
					<div class="main-content">
						<div class="wysiwyg">
							<div class="search-adv-row"><h3>Find pages with...</h3></div>
   ...
   <!--                     </xsl:choose></div>-->
			<!--				</div>-->
							<div class="search-adv-row"><input style="float:right;" type="submit" name="btnG" value="{$search_button_text}" /></div>
						</div>
					</div>
				</div>
			</section>
  ...
  <xsl:text disable-output-escaping="yes">&lt;form name="gs" method="GET" action="search" onsubmit="return (this.q.value == '') ? false : true;"&gt;</xsl:text>
    ...
    <div class="helper-clearfix search-box">    
          ...
          <xsl:if test="($type = 'swr')">
          	<div class="helper-clearfix">
              <span>There were about <b><xsl:value-of select="RES/M"/></b> results for <strong><xsl:value-of select="$space_normalized_query"/></strong>.</span>
              <br/>
...
<xsl:template name="bottom_search_box">
    <div class="main-content">
    	<div class="section-header search-no-margin"><xsl:text></xsl:text></div>
    	<div>
          <xsl:call-template name="search_box">
  ...
  <xsl:choose>
    ...
    <xsl:otherwise>
      ...
      <xsl:if test="$show_onebox != '0' and count(/GSP/ENTOBRESULTS) &gt; 0">
        <div class="main-content"><xsl:call-template name="onebox"/></div>
      </xsl:if>
      ...
      <!-- *** output google desktop results (if enabled and any available) *** -->
      <xsl:if test="$egds_show_desktop_results != '0'">
          <div class="main-content"><xsl:call-template name="desktop_results"/></div>
      </xsl:if>

      <!-- *** output results details *** -->
      <xsl:if test="$show_res_clusters = '1'">
        <div class="main-content"><xsl:call-template name="cluster_results"/></div>
      </xsl:if>
...
<div class="column-full column-standard column-last ">
  ...
  <xsl:if test="$show_spelling != '0' and $show_synonyms != '0'">
    <div class="main-content"><xsl:call-template name="synonyms"/></div>
  </xsl:if>
