...
********************************************************************** -->
 ...
 Logo setup (can be customized)
  ...
  <xsl:variable name="logo_url">http://med.emory.edu/assets/images/logo-secondary.svg</xsl:variable>
 ...
 Global JS - BLR
  ...
  <xsl:template name="js">
    ...
    <script src="//med.emory.edu/assets/js/jquery.min.js"></script>
    <script src="//med.emory.edu/assets/js/jquery.fitvids.js"></script>
    <script src="//med.emory.edu/assets/js/modernizr-custom.js"></script>
    <script src="//med.emory.edu/assets/js/svg4everybody.js"></script>
    <script src="//med.emory.edu/assets/js/main.js"></script>
    <script src="//med.emory.edu/assets/js/cfprofileimage.js"></script>
    <script src="//med.emory.edu/assets/js/foundation.min.js"></script>
    <link href="//med.emory.edu/assets/css/style.css" rel="stylesheet" type="text/css"/>
    <link href="//med.emory.edu/assets/css/additions.css" rel="stylesheet" type="text/css"/>
    <!-- Google Tag Manager -->
    <script>//<![CDATA[ 
    ...
    })(window,document,'script','dataLayer','GTM-KJC55B4');
    //]]></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/autotrack/2.4.1/autotrack.js"></script>

    <script>
        //<![CDATA[ Setup GA queue
        ...
        ga(function(){
            const setupSOMTrackersPlugins = function() {
                const somTracker =  ga.getAll().filter(function(tracker) {console.log(tracker);return (tracker.b.data.values[":trackingId"] == 'UA-31572272-1' && tracker["I"])})[0];
                
                if(!somTracker){
                    setTimeout(setupSOMTrackersPlugins, 50);
                    return;
                }
                const someTrackerName = somTracker.b.data.values[":name"];
...
<!-- End Google Tag Manager -->
 ...
 Global Meta - BLR
  ...
  <xsl:template name="meta">
    ...
    <meta content="//med.emory.edu/assets/images/logo-shield.svg" property="og:image"/>
  </xsl:template>
  <!-- **********************************************************************
      ...
      <div class="main-footer__primary">
        <div class="main-footer__primary-wrapper">
          <div class="main-footer__logo">
            <a class="logo " href="//med.emory.edu/">
              <img alt="Logo" src="//med.emory.edu/assets/images/prev-images/logo-parent-invert.svg"/> </a>
          </div>
          <div class="link-collection ">
            ...
            <ul>
              <li>
                <a href="//med.emory.edu/about/contact-us.html">Contact Us</a>
              </li>
              <li>
                <a href="//med.emory.edu/about/location/directions/index.html">Maps &amp; Directions</a>
              </li>
            </ul>
          </div>
          <div class="link-collection ">
            ...
            <ul>
              <li>
                <a href="//med.emory.edu/giving/alumni/index.html">Alumni</a>
              </li>
              <li>
                <a href="//med.emory.edu/faculty/index.html">Faculty &amp; Staff</a>
              </li>
              <li>
                <a href="//med.emory.edu/clinical-experience/advanced-patient-care/for-patients/index.html">Patients</a>
              </li>
              <li>
                <a href="//med.emory.edu/education/gme/index.html">Residents &amp; Fellows</a>
              </li>
              <li>
                <a href="//med.emory.edu/student-info/index.html">Students</a>
              </li>
            </ul>
          </div>
            ...
            <div class="social-media "  xmlns:xlink="https://www.w3.org/1999/xlink">
              <a class="social-media--icon" href="https://www.facebook.com/EmoryMedicine/">
                <svg role="img" class="icon" aria-labelledby="facebook_5afe3c263c924">
                  ...
                  <use xlink:href="//med.emory.edu/assets/images/sprites/svg-sprite-custom-symbol.svg#facebook"></use>
                </svg>
                <span class="show-for-sr">facebook</span>
              </a>
              <a class="social-media--icon" href="//med.emory.edu/https://twitter.com/EmoryMedicine">
                <svg role="img" class="icon" aria-labelledby="twitter_5afe3c263c978">
                  <title id="twitter_5afe3c263c978">twitter</title>
                  <use xlink:href="//med.emory.edu/assets/images/sprites/svg-sprite-custom-symbol.svg#twitter"></use>
                </svg>
                <span class="show-for-sr">twitter</span>
              </a>
              <a class="social-media--icon" href="//med.emory.edu/https://www.linkedin.com/school/emory-university-school-of-medicine/">
                <svg role="img" class="icon" aria-labelledby="linkedin_5afe3c263c9c5">
                  <title id="linkedin_5afe3c263c9c5">linkedin</title>
                  <use xlink:href="//med.emory.edu/assets/images/sprites/svg-sprite-custom-symbol.svg#linkedin"></use>
                </svg>
                <span class="show-for-sr">linkedin</span>
              </a>
              <a class="social-media--icon" href="//med.emory.edu/https://www.instagram.com/explore/locations/3325139/emory-university-school-of-medicine/?hl=en">
                <svg role="img" class="icon" aria-labelledby="instagram_5afe3c263ca11">
                  <title id="instagram_5afe3c263ca11">instagram</title>
                  <use xlink:href="//med.emory.edu/assets/images/sprites/svg-sprite-custom-symbol.svg#instagram"></use>
                </svg>
                <span class="show-for-sr">instagram</span>
              </a>
              <a class="social-media--icon" href="//med.emory.edu/https://www.youtube.com/user/EmoryUniversity/featured">
                <svg role="img" class="icon" aria-labelledby="youtube_5afe3c263ca5c">
                  <title id="youtube_5afe3c263ca5c">youtube</title>
                  <use xlink:href="//med.emory.edu/assets/images/sprites/svg-sprite-custom-symbol.svg#youtube"></use>
                </svg>
      ...
      <div class="main-header__wrapper">
        <div class="main-header__wrapper-inner">
          <div class="main-header__logo">
            <a class="logo " href="//med.emory.edu/index.html">
              <img alt="Logo" src="//med.emory.edu/assets/images/logo-secondary.svg" />
            </a>
          </div>
          <div class="main-header__logo-sticky">
            <a class="logo " href="//med.emory.edu/index.html">
              <img alt="Logo" src="//med.emory.edu/assets/images/prev-images/logo-shield.svg" />
            </a>
          </div>
          <div class="main-header__links-wrapper">
            <nav aria-label="Main Navigation" class="global-main-nav " role="navigation">
              <ul class="global-main-nav__list">
                <li class="global-main-nav__parent-item toggleDropdown">
                  <a class="global-main-nav__parent-link" href="//med.emory.edu/about/index.html">About</a>
                </li>
                <li class="global-main-nav__parent-item toggleDropdown">
                  <a class="global-main-nav__parent-link" href="//med.emory.edu/education/index.html">Education</a>
                </li>
                <li class="global-main-nav__parent-item toggleDropdown">
                  <a class="global-main-nav__parent-link" href="//med.emory.edu/research/index.html">Research</a>
                </li>
                <li class="global-main-nav__parent-item toggleDropdown">
                  <a class="global-main-nav__parent-link" href="//med.emory.edu/clinical-experience/index.html">Clinical Experience</a>
                </li>
              </ul>
            </nav>
            <nav aria-label="Utility Navigation" class="global-utility-nav " role="navigation">
              <ul>
                <li>
                  <a href="//med.emory.edu/giving/index.html">Giving</a>
                </li>
                <li>
                  <a href="//med.emory.edu/directory/index.html">Directory</a>
                </li>
              </ul>
            </nav>
          </div>
