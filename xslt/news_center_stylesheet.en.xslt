...
<xsl:variable name="exLt">&amp;lt;</xsl:variable>
<!-- **********************************************************************
...
&lt;div id="container960"&gt;
    &lt;div id="wrapper"&gt;
        &lt;div id="mast" class="gsa_template" &gt;
            &lt;div id="logo"&gt;&lt;a href="https://news.emory.edu/index.html"&gt;&lt;img alt="Emory News Center" id="banner" src="https://news.emory.edu/images/banner.png" /&gt;&lt;/a&gt;&lt;/div&gt;
            &lt;div id="mast_right"&gt; 
                &lt;div id="utils"&gt; 
                    ...
                    &lt;/li&gt;&lt;li class="topLevel" id="utility_search"&gt;&lt;a class="utilLink" title="Search"&gt;&lt;span&gt;Search&lt;/span&gt;&lt;/a&gt;&lt;div class="flyOut searchFlyOut"&gt;&lt;div id="search_news"&gt;
                        &lt;form action="https://search.emory.edu/" method="get" name="searchForm"&gt;&lt;!--&lt;input name="q" type="hidden" /&gt;--&gt;
                            &lt;div class="input" id="searchInput"&gt;&lt;input id="globalsearchinput" name="q" onclick="removeSearchDefault();" 
type="text" value="Search Emory News Center"/&gt;&lt;/div&gt;
                            &lt;div class="input" id="searchBtn"&gt;&lt;input src="https://www.emory.edu/template_shared/images/search-btn.gif" type="image"/&gt; &lt;a href="http://news.emory.edu/search/index.html"&gt;options &lt;/a&gt;&lt;/div&gt;
...
&lt;div id="expert-search" class="search-results"&gt;
  &lt;h2 class="header"&gt;&lt;img src='https://news.emory.edu/images/icons/search_again.png'alt='Search Again'/&gt;&lt;/h2&gt;
...
function removeSearchDefault() {
	if(document.getElementById('globalsearchinput').value == 'Search Emory News Center') 
...
<xsl:comment>
  ...
  <link href="https://news.emory.edu/css/webfonts-async.css" rel="stylesheet" type="text/css"/>
  <script src="https://news.emory.edu/scripts/webfonts-tracking.js" type="text/javascript"></script>
  <link href="https://news.emory.edu/css/default.css" rel="stylesheet" type="text/css"/>
  <link href="https://news.emory.edu/css/story.css" media="all" rel="stylesheet" type="text/css"/>
  
  <link href="https://news.emory.edu/css/utility_nav_2013.css" media="all" rel="stylesheet" type="text/css"/>
  <link href="https://news.emory.edu/css/nav_webfonts.css" media="all" rel="stylesheet" type="text/css"/>
  <link href="https://news.emory.edu/css/topnav_main-2013.css" media="all" rel="stylesheet" type="text/css"/>
  <link href="https://news.emory.edu/css/other.css" media="all" rel="stylesheet" type="text/css"/>
  <link href="https://news.emory.edu/css/experts.css" media="all" rel="stylesheet" type="text/css"/>
        <link href="https://news.emory.edu/css/search-gsa.css" media="all" rel="stylesheet" type="text/css" />
  
        <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.6.2/jquery.min.js" type="text/javascript" ></script>
        <script src="https://news.emory.edu/scripts/ap-todays-date.js" type="text/javascript" ></script>
        <script src="https://news.emory.edu/scripts/search_forms.js" type="text/javascript" ></script>
        <script src="https://news.emory.edu/scripts/jquery.emory.cross-slide.js" type="text/javascript" ></script>
        <script src="https://news.emory.edu/scripts/iframe_chrome.js" type="text/javascript" ></script> 
        <script src="https://news.emory.edu/scripts/search-switch-news.js" type="text/javascript" ></script> 
<script src="https://news.emory.edu/scripts/ie_hover_menu.js" type="text/javascript" ></script> 
...
<html>
  ...
  <xsl:call-template name="langHeadStart"/>
    ...
    <xsl:call-template name="style"/>
    <div style="display:none !important" id="pageQuery"><xsl:value-of select="translate($stripped_search_query, '&lt;', '`')"/></div>
    <script type="text/javascript">
      <xsl:comment>
        <xsl:if test="$show_sidebar = '1'">
        ...
        // Search query
        var page_query = document.getElementById('pageQuery').textContent.toString().replace(/`/g, '&lt;');
