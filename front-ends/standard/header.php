...
<html
	...
	<head>
		...
		<title>Search | Emory University | Atlanta GA</title>
		<!-- CSS INCLUDES -->
		<link href="//template.emory.edu/shared-assets/css/standard-template-v3.css?raw=&amp;lastModified=1532104603417" rel="stylesheet"/>
	...
	<body>
		<header>
			...
			<div id="header">
				<a class="sr-only" id="top">Top of page</a>
				<a class="sr-only" href="#main">Skip to main content</a>
				<div class="header fixed-top" id="siteHeader">
					<nav aria-label="Main site navigation" class="navbar navbar-expand-lg">
						<a class="header-logo" href="http://www.emory.edu">
							<img alt="Emory University Logo" class="header-logo__svg" src="https://template.emory.edu/sites/standard-BS4-template/public/_includes/images/eu-logo-shield.svg"/>
						</a>
						<!-- /.header-logo -->
						<div class="header-sitename">
							<svg
								xmlns="http://www.w3.org/2000/svg" class="header-sitename__svg" height="13" width="171"
								xmlns:xlink="http://www.w3.org/1999/xlink">
								<title>Emory University Search</title>
								<defs>
							...
							<a class="header-sitename__title" href="index.html">Search</a>
						</div>
						<!-- /.header-sitename -->
						<!-- Mobile nav toggler -->
						<button aria-controls="mainNav" aria-expanded="false" aria-label="Toggle navigation" class="navbar-toggler collapsed" data-target=".navbar-collapse" data-toggle="collapse" type="button">
							<span>Menu</span>
						</button>
						<!-- Begin menus -->
								...
								<div class="header-menus__bottom">
									<div class="header-nav-main">
										<ul class="navbar-nav" id="nav-main">
											<li class="nav-item ">
												<a class="nav-link" href="http://www.emory.edu" target="_self">
                                                    Home                                                                                    
                                                </a>
											</li>
											<li class="nav-item ">
												<a class="nav-link" href="http://www.emory.edu/home/about/index.html" target="_self">
                                                    About                                                                                   
                                                </a>
											</li>
										</ul>
		...
		<main>
			<div class="main-content">
				<a class="sr-only" id="main">Main content</a>
