<?php
    ...
    if(!isset($_GET["mindbreeze"])){
        include $_SERVER['DOCUMENT_ROOT'] . '/front-ends/standard/header.php';
        include $_SERVER['DOCUMENT_ROOT'] . '/front-ends/standard/cse.php';
    ...
    if($site == 'default_collection') {
        include $_SERVER['DOCUMENT_ROOT'] . '/front-ends/standard/header.php';
        include $_SERVER['DOCUMENT_ROOT'] . '/front-ends/standard/default_collection.php';
        include $_SERVER['DOCUMENT_ROOT'] . '/front-ends/standard/footer.php';
        exit;
    } else {
    
    $searchURL = 'https://mindbreeze.emory.edu/plugin/GSA/search?output=xml';
    $bestBetsURL = 'https://mindbreeze.emory.edu/plugin/GSA/search?output=xml&requiredfields=category:BestBets&q=%20';
